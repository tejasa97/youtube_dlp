...
func bilibiliProductOp(t *testing.T, transport *network.Client, rawURL, format string) (*operation, string) {
	...
	return &operation{client: newBroadTestClient(), request: request, transport: transport, registry: productRuntime(), compatibility: compatibility, rootExtractor: &rootExtractor, plannerCapabilities: &capabilities}, root
}

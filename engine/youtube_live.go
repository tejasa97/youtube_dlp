...
func (coordinator *youtubeLiveRefreshCoordinator) extractSource(ctx context.Context, sourceURL string) (Extraction, error) {
	operation := coordinator.operation
	if operation == nil || operation.client == nil || operation.transport == nil {
		return Extraction{}, youtubelive.ErrLiveRefreshFailed
	}

...
func (YouTube) Extract(ctx context.Context, request Request) (Extraction, error) {
	...
	youtubeOptions := request.Options
...
// ParsedTarget is the narrow compatibility view used by generic embed
// discovery without exposing provider implementation state.

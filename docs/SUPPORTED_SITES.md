...
| vimeo | vimeo.com videos and contextual channel/group/album/showcase child URLs with bounded public text tracks, channels, user profiles, and groups | playlist/API, manifest-heavy |

...
| soundcloud | soundcloud.com tracks with original downloads and opt-in public comments, sets, bare profiles, all pinned public profile tabs, legacy API user playlists, player/embed URLs, and bounded public search | playlist/API |

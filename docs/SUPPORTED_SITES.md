...
| vimeo | vimeo.com videos and contextual child URLs with bounded public text tracks, channels, user profiles, groups, and numeric public album/showcase playlists | playlist/API, manifest-heavy |
...
| soundcloud | soundcloud.com tracks, sets, bare profiles, all pinned public profile tabs, legacy API user playlists, and bounded public search | playlist/API |

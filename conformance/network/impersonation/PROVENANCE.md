...
v1.10.0 and later require Go 1.24.1. The product now requires Go 1.25 for
security-fixed transitive dependencies, but retains the reviewed v1.9.2 profile
until a separate conformance upgrade. It combines a uTLS ClientHello with fhttp

...
generic rate limit, `Retry-After`, or any `api.vimeo.com` 429 behavior. Tests
also assert the inverse host/status pairs remain unclassified and that signed
query values are never included in diagnostics.

...
The manifests in this directory cover the Go port's Plugin ABI v1. They contain no captured response, executable, credential,
...
- Numeric version `1` preserves the original wire value for v1.0. Numeric
